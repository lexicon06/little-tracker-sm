...
--
-- Table structure for table `player_playtime`
--
...
CREATE TABLE `player_playtime` (
  ...
  `daily_playtime` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `weekly_playtime` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Indexes for table `player_playtime`
--
ALTER TABLE `player_playtime`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_steamid` (`steamid`),
  ADD KEY `idx_daily_playtime` (`daily_playtime`),
  ADD KEY `idx_weekly_playtime` (`weekly_playtime`);
...
--
-- AUTO_INCREMENT for table `player_playtime`
--
ALTER TABLE `player_playtime`
